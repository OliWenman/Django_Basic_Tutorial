...
class QuestionModelTests(TestCase):
	...
	def test_was_published_recently_with_recent_question(self):
		...
		"""
		Was publushed recently returns True for questions whose published_date
		is within the the last day
		"""
...
def create_question(question_text, days):
	...
	published in the past, postitive for questions that habe yet to
	be published).
	"""
...
class QuestionIndexViewTests(TestCase):
	...
	def test_past_question(self):
		...
		"""
		Questions with published_date in the past are displayed on the
		index page
		"""
	...
	def test_future_question(self):
		...
		"""
		Questions with a pub date in the future aren't 
...
class QuestionDetailViewTests(TestCase):
	...
	def test_future_question(self):
		...
		"""
		The detail view of a question with a published_date in the
...
"""
Create test for questions with no choice to not be published/shown.
"""
